        ...
        <div className='homeRoot'>
            <div className='home'>
                <div className='introBlock'>
                    <div>
                        <h1>Where great <span style={style.themeWord}>minds</span> are in the same <span style={style.themeWord}>orbit</span>.</h1>
                        <span>Explore the greatest community of knowledge and become one of the best. Create your own orbit.</span>
                        <Buttons />
                    </div>
                    <Thinking width={512} height={512} />
                </div>
